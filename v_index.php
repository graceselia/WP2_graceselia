...
href="http://localhost/pustaka-booking/assets/css/stylebuku.css"> 
    <h1><?php echo $judul ?></h1> 
        ...
        atau fungsi yang berhubung dengan pengolahan database di letakkan di dalam 
        model. Sebagai contoh, jika ingin membuat aplikasi untuk menghitung luas 
        ...
        untuk mendesign tampilan aplikasi, karena back-end developer yang 
